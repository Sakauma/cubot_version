...
void get_img_vec(std::string img_root , std::vector<cv::Mat> &imgs , std::vector<int> &labeles ,int pos_or_neg,int needEqualizeFlag)
{
    Mat m,gray0,gray1;
    ...
    std::string model_name = "/home/cubot/roboMaster2018/infantry_sample/cfg/svm_hog_infantry.xml";
#else
...
int main()
{
    std::string train_path = "/home/cubot/roboMaster2018/train/";
    ...
    get_img_vec(train_path + "train9/pos/",imgs,labeles,1,0);
    ...
    get_img_vec(train_path + "train10/neg/",imgs,labeles,0,1);
    get_img_vec(train_path + "train11/neg/",imgs,labeles,0,0);
