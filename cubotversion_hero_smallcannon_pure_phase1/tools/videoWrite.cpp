...
VideoWriter writer("VideoTest_Fuwen2.avi", CV_FOURCC('M', 'J', 'P', 'G'), rate, videoSize);
...
//target_link_libraries(videoWrite ${OpenCV_LIBS} ${Boost_LIBRARY} imgSubscrible boost_thread boost_system )
